...
//                	float legs = MathHelper.clamp((float)(wolf.motionY), -0.4F, 0.4F) + 0.3F;
                ...
                else /* not leaping */
                {
                    ...
                    this.lHindLeg01.rotateAngleX = MathHelper.sin(limbSwing * 0.8665F + (float) Math.PI) * 0.5F * limbSwingAmount - 0.228F;
                    this.rHindLeg01.rotateAngleX = MathHelper.cos(limbSwing * 0.8665F) * 0.5F * limbSwingAmount - 0.1F;
                    this.lForeleg01.rotateAngleX = MathHelper.sin(limbSwing * 0.8665F) * 0.5F * limbSwingAmount + 0.1F;
                    this.rForeleg01.rotateAngleX = MathHelper.cos(limbSwing * 0.8665F + (float) Math.PI) * 0.5F * limbSwingAmount + 0.228F;
