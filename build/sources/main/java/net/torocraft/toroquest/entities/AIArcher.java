...
//      }
    ...
    public void updateTask()
    {
        if ( shouldExecute() )
        {
            double d0 = this.entity.getDistanceSq(this.entity.getAttackTarget().posX, this.entity.getAttackTarget().getEntityBoundingBox().minY, this.entity.getAttackTarget().posZ);
