...
//	}
	...
	public void spawnSweepParticles()
	{
		...
		double yy = this.posY + (double) this.height * 0.5D;
		...
		if (this.world instanceof WorldServer)
		{
			for ( int i = 16; i > 0; i-- )
			{
				((WorldServer) this.world).spawnParticle(EnumParticleTypes.REDSTONE, xx+this.rand.nextGaussian()/10.0D, yy+this.rand.nextGaussian()/10.0D, zz+this.rand.nextGaussian()/10.0D, 0, 0, 0, 0, 0.01D, new int[0]);
			}
		}
	}
