...
//	}
	...
	protected void initEntityAI()
	{
		...
		this.tasks.addTask(1, new EntityAIAvoidEntity<EntityPlayer>(this, EntityPlayer.class, PLAYER_WITH_LEAD, 16.0F, 0.7D, 0.9D));
		this.tasks.addTask(2, new EntityAIAvoidEntity<EntityPlayer>(this, EntityPlayer.class, 10.0F, 0.6D, 0.8D));
		this.tasks.addTask(3, new EntityAIAvoidEntity<EntityToroNpc>(this, EntityToroNpc.class, 8.0F, 0.4D, 0.6D));
	...
	public void onDeath(DamageSource cause)
	{
		...
		if (!world.isRemote)
		{
			...
			dropItem(Items.EMERALD, rand.nextInt(3)+1);
		}
	}
