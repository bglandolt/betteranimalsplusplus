...
public class QuestCaptureFugitives extends QuestBase implements Quest
{
	...
	public List<ItemStack> complete(QuestData quest, List<ItemStack> items)
	{
		...
		if (!quest.getCompleted())
		{
			...
			{
				quest.setChatStack( "capture_fugitives.incomplete", quest.getPlayer(), quest.getCiv().getDisplayName() );
				this.setData(quest);
			}
		...
		quest.setChatStack( "capture_fugitives.complete", quest.getPlayer(), quest.getCiv().getDisplayName() );
		this.setData(quest);
		return items;
	}
	...
	public List<ItemStack> reject(QuestData quest, List<ItemStack> items)
	{
		...
		{
			quest.setChatStack( "rejectreturnitem", quest.getPlayer(), quest.getCiv().getDisplayName() );
			this.setData(quest);
			return null;
		}
		
		quest.setChatStack( "capture_fugitives.reject", quest.getPlayer(), quest.getCiv().getDisplayName() );
		this.setData(quest);
		quest.getPlayer().closeScreen();
		return items;
	}
	...
	public List<ItemStack> accept(QuestData data, List<ItemStack> in)
	{
		...
		in.add(itemstack);
		data.setChatStack( "capture_fugitives.accept", data.getPlayer(), data.getCiv().getDisplayName() );
		this.setData(data);
		return in;
	}
