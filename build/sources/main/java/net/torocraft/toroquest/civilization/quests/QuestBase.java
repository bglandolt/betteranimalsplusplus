...
public abstract class QuestBase implements Quest
{
	...
	public void chatCompletedQuest( QuestData data )
	{
		...
		{
			data.getPlayer().sendStatusMessage( new TextComponentString( I18n.format("quest.quest_complete_message") ), ToroQuestConfiguration.showQuestCompletionAboveActionBar );
		}
