...
public class ModelBadger extends ModelBase
{
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entity)
    {
    	...
    	if ( badger.abilityTick > 0 )
        {
    		// badger.abilityTick--;
            
            this.lLeg01.rotateAngleX = MathHelper.sin(badger.abilityTick/4.0F);
            this.rLeg01.rotateAngleX = MathHelper.cos(badger.abilityTick/4.0F + (float)Math.PI);
            
            this.front.rotateAngleX = 0.0F;
            this.rear.rotateAngleX = 0.275F;
        }
        ...
        {
        	this.front.rotateAngleX = -MathHelper.sin(badger.upTimer/8.0F)/6.0F - 0.1F;
        	this.rear.rotateAngleX = this.front.rotateAngleX/2.0F;
        	this.lArm01.rotateAngleX = -MathHelper.sin(badger.upTimer/4.0F)/6.0F - 0.1F;
        	this.rArm01.rotateAngleX = -MathHelper.cos((float) Math.PI + badger.upTimer/4.0F)/6.0F - 0.1F;
        }
