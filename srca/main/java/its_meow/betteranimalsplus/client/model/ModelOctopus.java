...
//    }
    ...
    public void render(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor)
    {
        ...
        if ( entity.isOverWater() || entity.motionX*entity.motionX+entity.motionZ*entity.motionZ > 0.01D )
        {
            this.setSwimPose();
            this.head.rotateAngleX = 0F;
            
            //float a = MathHelper.cos(ageInTicks * 0.2F) * 0.2F - 1.0F;
...
//            }
            ...
            this.lTentacle01a.rotateAngleX = MathHelper.cos(ageInTicks * 0.25F) * 0.16F - 0.28F;
    		this.lTentacle02a.rotateAngleX = MathHelper.cos(ageInTicks * 0.2F) * 0.22F - 0.3F;
    		this.lTentacle03a.rotateAngleX = MathHelper.cos(ageInTicks * 0.15F) * 0.18F - 0.31F;
    		this.lTentacle04a.rotateAngleX = MathHelper.cos(ageInTicks * 0.3F) * 0.2F - 0.32F;
    		this.rTentacle01a.rotateAngleX = MathHelper.cos(ageInTicks * 0.2F) * 0.16F - 0.28F;
    		this.rTentacle02a.rotateAngleX = MathHelper.cos(ageInTicks * 0.15F) * 0.22F - 0.29F;
    		this.rTentacle03a.rotateAngleX = MathHelper.cos(ageInTicks * 0.25F) * 0.2F - 0.31F;
    		this.rTentacle04a.rotateAngleX = MathHelper.cos(ageInTicks * 0.2F) * 0.16F - 0.3F;
    		
//			this.lTentacle01a.rotateAngleX = a*1.1F;
//			this.lTentacle02a.rotateAngleX = a*0.9F;
//			this.lTentacle03a.rotateAngleX = a;
//			this.lTentacle04a.rotateAngleX = a*1.15F;
//			this.rTentacle01a.rotateAngleX = a;
//			this.rTentacle02a.rotateAngleX = a*0.95F;
//			this.rTentacle03a.rotateAngleX = a*1.15F;
//			this.rTentacle04a.rotateAngleX = a*0.9F;
...
//            float a = MathHelper.cos(ageInTicks * 0.2F) * 0.2F;
//
//            this.lTentacle01a.rotateAngleY = -a-0.8F;
//            this.lTentacle02a.rotateAngleY = -a*1.5F-0.8F;
//            this.lTentacle03a.rotateAngleY = a-0.8F;
//            this.lTentacle04a.rotateAngleY = a*1.5F-0.8F;
//            this.rTentacle01a.rotateAngleY = -a-0.8F;
//            this.rTentacle02a.rotateAngleY = -a*1.5F-0.8F;
//            this.rTentacle03a.rotateAngleY = a-0.8F;
//            this.rTentacle04a.rotateAngleY = a*1.5F-0.8F;
