...
public class EntityBrownBear extends EntityMob
{
    ...
    {   	
        ...
        if (flag)
        {
        	if ( this.latchTimer <= 0 && ( (entityIn.motionX*entityIn.motionX+entityIn.motionZ*entityIn.motionZ) < 0.5D ) && this.grabTarget(this.getAttackTarget()) ) // attackReachModifier
            {
    ...
    public int attackAnimationTimerStanding = 0;
