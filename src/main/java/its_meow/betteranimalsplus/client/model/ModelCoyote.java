...
public class ModelCoyote extends ModelBetterAnimals {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entity)
    {
        ...
        else
        {
            ...
            if ( wolf.leaping >= 0 )
            {
                this.muzzleLower.rotateAngleX = MathHelper.clamp((float)(wolf.motionY*2.0D), 0.0F, 0.4F) + 0.5F; //  - 0.9
                
            	this.chest.rotateAngleX = -MathHelper.clamp((float)(wolf.motionY), -0.3F, 0.3F);
            	this.body.rotateAngleX = MathHelper.clamp((float)(wolf.motionY), -0.4F, 0.4F) + 0.1F;
            ...
            else
            {
                ...
                this.muzzleLower.rotateAngleX = 0.0F;
