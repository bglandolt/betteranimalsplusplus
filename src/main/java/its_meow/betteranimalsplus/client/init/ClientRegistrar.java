...
//        initModel(ModItems.BEAR_MEAT_RAW);
//        initModel(ModItems.BEAR_MEAT_COOKED);
//        initModel(ModItems.WOLF_MEAT_RAW);
//        initModel(ModItems.WOLF_MEAT_COOKED);
        initModel(ModItems.CHEESE);
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityBrownBear.class, RenderBrownBear::new);
