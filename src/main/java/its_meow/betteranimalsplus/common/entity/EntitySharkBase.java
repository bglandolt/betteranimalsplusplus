...
public abstract class EntitySharkBase extends EntityWaterMobPathingWithSelectiveTypes implements IMob {
    ...
    public void updatePassenger(Entity passenger)
    {
        ...
        {
            BlockPos pos = this.getPosition().offset(this.getHorizontalFacing());
            pos = pos.add(pos.getX()/2.0D, 0, pos.getZ()/2.0D);
            passenger.setPosition(this.motionX + pos.getX(), this.posY + this.motionY, this.motionZ + pos.getZ());
