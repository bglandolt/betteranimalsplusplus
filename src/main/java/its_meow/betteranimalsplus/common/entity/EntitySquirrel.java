...
//		this.motionZ *= mod;
    ...
    protected void initEntityAI() 
    {
        ...
        this.tasks.addTask(3, new EntityAITempt(this, 0.8D, Items.WHEAT_SEEDS, true)
        {
        	@Override
        ...
        this.tasks.addTask(4, new EntityAISquirrelAvoidEntity<EntityLivingBase>(this, 8.0F, 0.30D, 0.3D));
        //this.tasks.addTask(5, new EntityAIWanderAvoidWater(this, 1.0D, 15));
    }
